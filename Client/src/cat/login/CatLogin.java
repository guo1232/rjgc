...
public class CatLogin extends JFrame {
	...
	public CatLogin() {
		...
		textField.setBounds(128, 73, 104, 21);
	...
	protected void errorTip(String str) {
		...
		JOptionPane.showMessageDialog(contentPane, str, "错误信息",
